...
<context>
    ...
    <message>
        ...
        <translation>*Παρακαλούμε ελέγξτε τις επιλογές σας πριν από την εφαρμογή, η λανθασμένη ανάθεση μελών στην ομάδα μπορεί να σπάσει το σύστημά σας.  Αν κάνετε λάθος, χρησιμοποιήστε την επιδιόρθωση για να επαναφέρετε τα αρχικά μέλη.</translation>
    </message>
    <message>
