...
if [ "$DEBIAN_BUILD" = true ]; then
    ...
    rm -rf debian/.debhelper/ debian/mx-user/ obj-*/
...
if [ "$ARCH_BUILD" = true ]; then
    ...
    echo "Binary available at: build/mx-user"
    exit 0
fi
...
echo "Executable: $BUILD_DIR/mx-user"
